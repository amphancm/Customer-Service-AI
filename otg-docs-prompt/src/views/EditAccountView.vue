  ...
  <div class="h-full flex flex-col p-4">
    ...
    <div class="flex parent overflow-y-auto mt-4">
      <div class="overflow-x-auto w-full">
        <div class="flex">
          <div class="w-40 flex items-center text-left -mt-[20px]">
          ...
          <div class="flex-4 w-full">
            <input
              ...
              type="text"
              id="username"
              class="mb-3 ml-5 flex-grow max-w-[500px] px-3 py-2 rounded-2xl border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
     ...
     <div class="flex mt-4">
          <div class="w-40 flex text-left py-2">
            <h4 for="email" class="text-black ">Password</h4>
          </div>
          <div class="flex-4 w-full">
            <input
              v-model="account.username"
          ...
          <div class="flex mt-4">
          <div class="w-40 flex text-left py-2">
            <h4 for="email" class="text-black ">Confirm Password</h4>
          </div>
          <div class="flex-4 w-full">
            <input
              v-model="account.email"
         ...
         <div class="float-end mt-4">
            <button class="bg-[#E43A32] p-3 rounded-2xl text-white flex items-center gap-2 hover:bg-red-600" @click="handleSave">
              <img src="@/assets/icons/disk (2).png" width="18" height="18" alt="Chat" />
              Save
            </button>
          </div>
    ...
    >
      <template #body>
        <!-- <p>Are you sure?</p> -->
         <div class="mb-4">
          <div class="w-40 flex text-left py-2">
            <h4 for="password" class="text-black font-bold">Password</h4>
          </div>
